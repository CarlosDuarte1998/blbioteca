...
import com.mycompany.services.ObraFacade;
...
public class ObraController implements Serializable {
    ...
    @EJB
    private com.mycompany.services.ObraFacade ejbFacade;
    ...
    public Obra getObra(java.lang.Integer id) {
    ...
    public static class ObraControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getObra(getKey(value));
        }
